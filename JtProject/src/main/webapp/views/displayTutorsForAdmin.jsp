...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">
            <i class="fas fa-users me-2"></i>Управление преподавателями
        </a>
    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10 ms-sm-auto px-md-4 py-3">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Список преподавателей</h1>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Поиск преподавателей...">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <c:choose>
                        <c:when test="${empty clients}">
                            <tr>
                                <td colspan="7" class="text-center py-4">Нет данных о преподавателях</td>
                            </tr>
                        </c:when>
                        <c:otherwise>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Вы уверены, что хотите удалить преподавателя <span id="clientName" class="fw-bold"></span>?
            </div>
...
<div class="modal fade" id="createClientModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Добавление нового преподавателя</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
