...
<body class="bg-dark">
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
			<a class="navbar-brand" href="#"> <img
				src="../static/images/logo.jpg" width="auto" height="40"
	...
	<div class="jumbotron text-center">
		<h1 class="display-4">С возвращением, Администратор</h1><hr>
		<p>Изменяйте информацию с помощью этой панели администратора</p>
	</div><br>
	<div class="container-fluid" >
			...
			<div class="col-sm-3 pt-4">
				<div class="card" style="background-color: white;">
					<div class="card-body text-center">
						...
						<p>---------------------------------------------</p>
						<p class="card-text">Изменяйте информацию об учениках здесь.</p>
						<a href="/admin/clients" class="card-link btn btn-primary">Перейти</a>
