    ...
    <div class="col-sm-6">
        ...
        <form action="newuserregister" method="post">
            <div class="form-group">
                ...
                <input type="text" name="username" id="firstName" required placeholder="Ваше имя*" required class="form-control form-control-lg">
            </div>
            <div class="form-group">
                ...
                <small id="emailHelp" class="form-text text-muted">Мы не распространяем Вашу личную информацию.</small>
            </div>
            <div class="form-group">
...
<span style="margin-top: 10px">Уже есть аккаунт? <a class="linkControl" href="/">Войти здесь</a></span> <br><br>
            ...
            <input type="hidden" name="registrationStatus" id="registrationStatus" value="${registrationStatus}">
        </form>
    </div>
</div>
<!-- Модальное окно -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Успешная регистрация!</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p>Вы успешно зарегистрированы. Теперь можете войти в систему.</p>
            </div>
